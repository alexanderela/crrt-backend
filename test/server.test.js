  ...
  describe("GET /api/v1/cases", () => {
    ...
    it("should return an array of cases", done => {
      chai
        ...
        .get("/api/v1/cases")
        .end((error, response) => {
          const pastMedicalHistory1 = JSON.parse(
            response.body[0].historyOfPresentIllness
          ).pastMedicalHistory;
          const pastMedicalHistory2 = JSON.parse(
            response.body[1].historyOfPresentIllness
          ).pastMedicalHistory;
