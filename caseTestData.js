const caseStudies = [
  {
    ...
    historyOfPresentIllness: {
      ...
      pastMedicalHistory: [
        "Hypertension, Insulin-dependent Diabetes Mellitus Type 2, COPD, CKD 3 (baseline creatinine 1.4 - 1.6)"
      ],
  ...
  },
  {
    ...
    historyOfPresentIllness: {
      ...
      pastMedicalHistory: [
        "Hypertension, Alcohol abuse, Chronic pancreatitis, Pulmonary embolism, Diffuse chronic pain, Major Depressive Disorder"
      ],
...
const caseStudyWrongDataType = {
  sodiumProductionRate: "wrong data type",
  potassiumProductionRate: 4.3,
  chlorideProductionRate: 0,
  bicarbonateProductionRate: -20,
  BUNProductionRate: 40,
