const caseStudies = [
  ...
  },
  {
    ...
    historyOfPresentIllness: {
      ...
      pastMedicalHistory: ["Asthma", "Tobacco use"],
      ...
      familyHistory: ["No family history of renal disease or cancers."]
    },
    vitalSigns: {
    ...
    physicalExam: {
      ...
      lungs:
        "Decreased breath sounds in the right upper lobe, diffuse expiratory wheezing",
      abdomen: "Non-distended",
      extremities: "No edema",
      psych: "Intubated and sedated"
    },
